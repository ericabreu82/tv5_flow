...
te::qt::plugins::fiocruz::AbstractAction::AbstractAction(QMenu* menu) :
  m_menu(menu), 
  m_action(0)
{
}

te::qt::plugins::fiocruz::AbstractAction::~AbstractAction()
{
  // do not delete m_action pointer because its son of fiocruz menu... and qt delete automatically
}

void te::qt::plugins::fiocruz::AbstractAction::createAction(std::string name, std::string pixmap)
{
  assert(m_menu);
...
void te::qt::plugins::fiocruz::AbstractAction::addNewLayer(te::map::AbstractLayerPtr layer)
{
