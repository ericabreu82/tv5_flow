...
void te::qt::plugins::fiocruz::FlowNetworkRenderer::drawDatSetGeometries(te::da::DataSet* dataset, const std::size_t& gpos,
  te::map::Canvas* canvas, int fromSRID, int toSRID, te::map::Chart* chart, te::common::TaskProgress* task)
{
  te::map::AbstractLayerRenderer::drawDatSetGeometries(dataset, gpos, canvas, fromSRID, toSRID, chart, task);
}*/
