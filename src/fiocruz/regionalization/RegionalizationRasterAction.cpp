...
/*!
  \file fiocruz/src/fiocruz/regionalization/RegionalizationRasterAction.cpp
...
te::qt::plugins::fiocruz::RegionalizationRasterAction::RegionalizationRasterAction(QMenu* menu) :te::qt::plugins::fiocruz::AbstractAction(menu)
{
  createAction(tr("Raster Map...").toStdString(), "");
}

te::qt::plugins::fiocruz::RegionalizationRasterAction::~RegionalizationRasterAction()
{
}
